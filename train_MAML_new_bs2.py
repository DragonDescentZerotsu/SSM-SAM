...
from test_LARGE_new import save_fig
import numpy as np
...
def make_data_loaders_dict(all_task_list):
    ...
    for task in all_task_list:
        ...
        config['query_eval_dataset']['dataset']['args']['root_path_1'] = os.path.join(data_path, task, 'query_eval', 'img')
        config['query_eval_dataset']['dataset']['args']['root_path_2'] = os.path.join(data_path, task, 'query_eval', 'mask')
...
def main(config_, save_path, args):
    ...
    eval_task = 'spleen'  # TODO:做val_loader
    ...
    support_train_loader_dict, query_train_loader_dict, support_eval_loader_dict, query_eval_loader_dict = make_data_loaders_dict(all_train_task_list)
    ...
    for epoch in range(epoch_start, epoch_max + 1):
        ...
        train_loss_G = train(all_train_task_list, support_train_loader_dict, query_train_loader_dict,
                             support_eval_loader_dict, query_eval_loader_dict, model, loss_mode)
        lr_scheduler.step()
