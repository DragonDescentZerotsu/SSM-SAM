...
def eval_psnr(loader, model, eval_type=None):
    ...
    pbar = tqdm(total=min(len(loader) * config['test_dataset']['batch_size'], config['out_eval_INR']), leave=True, desc='evaluation')
...
def main(config_, save_path, args):
    ...
    eval_task = 'left_kidney'  # TODO:做val_loader
    exclude_task_list = ['USF_shadow', 'SBU_shadow', 'ISTD_shadow', 'polyp', 'COD10K', 'cup', 'BraTS20', eval_task,
                         'ISBI', 'transparent', 'all_train_meta_data', '__MACOSX', 'large_test', '.DS_Store', 'MRI_T2']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default="/root/SAM_Adapter_MAML/configs/cod-sam-vit-b.yaml")
